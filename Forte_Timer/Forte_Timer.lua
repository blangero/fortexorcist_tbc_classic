...
local function NewBar(parent,n)
  ...
  -- clickable icon
  bar.button = CreateFrame("Button",nil,bar,BackdropTemplateMixin and "BackdropTemplate");
...
local function NewGroup(parent,n)
  local group;
  parent.groups[n] = CreateFrame("Frame",nil,parent,BackdropTemplateMixin and "BackdropTemplate");
  ...
  group.background = CreateFrame("Frame",nil,group,BackdropTemplateMixin and "BackdropTemplate");
